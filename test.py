...
word2vec_model = gensim.models.KeyedVectors.load_word2vec_format('Data/nkjp+wiki-forms-all-300-cbow-hs-50.txt', binary=False, limit=50000)
...
rnn = model.fit(X_train, Y_train, epochs= 1, batch_size=batch_size, shuffle=True, validation_data=(X_val, Y_val))
